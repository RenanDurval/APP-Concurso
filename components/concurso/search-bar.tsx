        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
                <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium text-sm transition-all ${selectedStatus === 'todos'
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium text-sm transition-all ${selectedStatus === 'aberto'
                ...
                <button
                    onClick={() => handleStatusChange('previsto')}
                    className={`px-4 py-2 rounded-lg font-medium text-sm transition-all ${selectedStatus === 'previsto'
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium text-sm transition-all ${selectedStatus === 'encerrado'
